...
// Post /:supi/gba-security-information/generate-av
// Generate authentication data for the UE in GBA domain
func HTTPGenerateGbaAv(c *gin.Context) {
	detail := "Handle Post /:supi/gba-security-information/generate-av is not implemented"
