...
func getRoutes() []Route {
	return []Route{
		...
		{
			"EventOccurrenceNotificationRequestBodyCallbackReferencePost",
			http.MethodPost,
			"/:request.body#/callbackReference",
			HTTPEventOccurrenceNotificationRequestBodyCallbackReferencePost,
		},
		{
			"MonitoringRevocationNotificationRequestBodySecondCallbackRefPost",
			http.MethodPost,
			"/:request.body#/secondCallbackRef",
			HTTPMonitoringRevocationNotificationRequestBodySecondCallbackRefPost,
		},
	}
}
