...
// Get /:ueId/registrations/auth-trigger
// trigger the primary (re-)authentication
func HTTPAuthTrigger(c *gin.Context) {
	logger.UecmLog.Warnln("Handle Get /:ueId/registrations/auth-trigger is not implemented")
